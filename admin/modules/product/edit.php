                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="ManHinh" value="<?php echo $EditProduct2['ManHinh'] ?>">
                                     </div>
                               
                                    <label for="input2" class="col-sm-1 text-right">HDH</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="HDH" value="<?php echo $EditProduct2['HDH'] ?>">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="Camtruoc" value="<?php echo $EditProduct2['Camtruoc'] ?>">
                                     </div>
  
                                    <label for="input2" class="col-sm-1 text-right">Cam sau</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="Camsau" value="<?php echo $EditProduct2['Camsau'] ?>">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="CPU" value="<?php echo $EditProduct2['CPU'] ?>">
                                     </div>

                                    <label for="input2" class="col-sm-1 text-right">RAM</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="RAM" value="<?php echo $EditProduct2['RAM'] ?>">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="ROM" value="<?php echo $EditProduct2['ROM'] ?>">
                                     </div>

                                    <label for="input2" class="col-sm-1 text-right">SDCar</label>
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="SDCar" value="<?php echo $EditProduct2['SDCar'] ?>">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="input2" name="Pin" value="<?php echo $EditProduct2['Pin'] ?>">
                                     </div>
                                 </div>
